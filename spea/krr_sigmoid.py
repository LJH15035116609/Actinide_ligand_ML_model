...
datasets = {
"data1": data[['Electrophilicity','logK','kfold']],
"data2": data[['Nucleophilicity.1','logK','kfold']],
"data3": data[['First IE_metal  (kJ/mol)','logK','kfold']],
"data4": data[['fourth IE_metal  (kJ/mol)','logK','kfold']],
"data5": data[['EState_VSA9','logK','kfold']]
}
