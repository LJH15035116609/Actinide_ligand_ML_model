...
datasets = {
"data1": data[ ['HallKierAlpha', 'SMR_VSA1','logK','kfold']],
"data2": data[ ['HallKierAlpha', 'SMR_VSA1','logK','kfold']],
"data3": data[ ['HallKierAlpha', 'SMR_VSA1','logK','kfold']],
"data4": data[ ['HallKierAlpha', 'SMR_VSA1','logK','kfold']],
"data5": data[ ['HallKierAlpha', 'TPSA','logK','kfold']]
}
...
results_df.to_csv('KernelRidge_sigmoid_cross_validation_results.csv', index=False)
